"""
Example demonstrating conversion from Bayesian Network to Markov Network.

This example shows how to convert a Bayesian Network containing only CPTs
to a Markov Network using the to_markov_network() method.
"""
...
def main():
    ...
    for i in range(3):
        particle = bn.sample()
        print(f"Sample {i+1}: X={particle.get_value('X')}, "
