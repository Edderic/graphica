...
def main():
    ...
    det_var = Deterministic(name='det_var', callable_func=sum_func,
                           normal_var=normal_var, gamma_var=gamma_var, beta_var=beta_var)
    bn.add_node(det_var)
    ...
    for i in range(5):
        ...
        expected_det = (new_particle.get_value('normal_var') + 
